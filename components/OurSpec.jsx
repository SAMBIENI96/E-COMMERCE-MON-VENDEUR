...
const OurSpecs = () => {
    ...
    return (
        <div className='px-6 my-20 max-w-6xl mx-auto'>
            <Title visibleButton={false} title='Pourquoi Go-shop' description="Nous mettons en avant des vendeurs locaux, un service simple et une experience d'achat rassurante pour tout le Benin." />
