...
export default function Banner() {
    ...
    const handleClaim = () => {
        ...
        navigator.clipboard.writeText('BIENVENUE20');
    };
    ...
    return isOpen && (
        <div className="w-full px-6 py-1 font-medium text-sm text-white text-center bg-gradient-to-r from-violet-500 via-[#9938CA] to-[#E0724A]">
            <div className='flex items-center justify-between max-w-7xl mx-auto'>
                <p>Profitez de 20% sur votre premiere commande Go-shop !</p>
                <div className="flex items-center space-x-6">
                    <button onClick={handleClaim} type="button" className="font-normal text-gray-800 bg-white px-7 py-2 rounded-full max-sm:hidden">Recuperer l'offre</button>
