  ...
  const linkSections = [
    {
      title: "NOS RAYONS",
      links: [
        { text: "Mode africaine", path: "/shop", icon: null },
        { text: "High-tech", path: "/shop", icon: null },
        { text: "Maison", path: "/shop", icon: null },
        { text: "Beaute", path: "/shop", icon: null },
      ],
    },
    {
      title: "GO-SHOP",
      links: [
        ...
        { text: "A propos", path: "/about", icon: null },
        { text: "Promotions", path: "/pricing", icon: null },
        { text: "Ouvrir une boutique", path: "/create-store", icon: null },
      ],
    },
    {
      title: "CONTACT",
      links: [
        { text: "+229 01 90 00 00 00", path: "/contact", icon: PhoneIcon },
        { text: "bonjour@goshop.bj", path: "/contact", icon: MailIcon },
        { text: "Marche Dantokpa, Cotonou", path: "/contact", icon: MapPinIcon },
      ],
    },
  ];
    ...
    <footer className="mx-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
          <div>
            ...
            <p className="max-w-[410px] mt-6 text-sm">
              Go-shop rapproche les acheteurs et vendeurs du Benin dans une meme
              place de marche en ligne. Retrouvez des produits du quotidien, des
              bons plans locaux et des boutiques serieuses en quelques clics.
            </p>
          </div>
        ...
        <p className="py-4 text-sm text-slate-500">
          Copyright {new Date().getFullYear()} Go-shop Benin. Tous droits reserves.
        </p>
      </div>
    </footer>
  );
